    ...
    <div className="m-auto mt-12 w-[70vw]">
      ...
      <div className="flex flex-col gap-4">
        <Accordion
          ...
          imagePosition="left"
        >
          <div className="grid grid-cols-2 gap-12 px-12 py-12">
        ...
        <Accordion
          ...
          imagePosition="right"
        >
          <div className=" grid grid-cols-3 gap-10 px-12 py-12">
        ...
        <Accordion
          ...
          imagePosition="left"
        >
          <div className=" grid grid-cols-2 gap-10 px-12 py-12">
        ...
        >
          <div className="flex flex-col">
            {ceretta.map((service, index) => (
              <div key={index} className=" flex flex-col gap-8 px-12 py-12">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="w-[50%] text-sm font-light">
                    {service.description}
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-7 gap-x-4 gap-y-8">
                    {service.subcategories.map((subcategory, subIndex) => (
                      <div className="flex flex-col gap-2" key={subIndex}>
                        ...
                        <h4 className="w-[85%] text-sm">{subcategory.title}</h4>
                      </div>
                    ))}
                  </div>
                )}
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4">
                    {service.subcategories.map((subcategory, subIndex) => (
                      <div className="flex flex-col gap-2" key={subIndex}>
                        ...
                        <h4 className="w-[85%] text-xs">{subcategory.title}</h4>
                      </div>
                    ))}
                  </div>
                )}
